module.exports = {
  ...
  ignorePatterns: ['common-package/plugins/iconify/*.js', 'node_modules', 'dist', '*.d.ts', 'vendor', '*.json'],
  rules: {
    'no-console': process.env.NODE_ENV === 'production' ? 'warn' : 'off',
    'no- ': process.env.NODE_ENV === 'production' ? 'warn' : 'off',
    'eslint-comments/no-unlimited-disable': 'off', // 去掉对于不检验ts类型的地方，详细说明
    ...
    'vue/component-api-style': 'off', // 允许 Options API
